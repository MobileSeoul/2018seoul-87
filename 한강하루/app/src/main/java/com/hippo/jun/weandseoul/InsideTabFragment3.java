...
public class InsideTabFragment3 extends Fragment {

    public InsideTabFragment3(){
        // 빈 생성자 필수
    }

    String domain = "http://tkstka0023.cafe24.com/food_truck/";
    int openNum;

    @Override
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.inside_tab_fragment3, container, false);
        ...
        if(parkNameEng.equals("yeouido") | parkNameEng.equals("banpo") | parkNameEng.equals("jamsil") | parkNameEng.equals("nanji")) {
            ...
            try{
                ...
                //배열의 크기에 맞게 for문 실행하고 NAME 값을 받아온다.
            ...
            Intent intent = new Intent(getActivity(), PlaceInfoActivity3.class);
    ...
    public String loadJSONFromAsset() {
        String json = null;
        try {
            InputStream is = getActivity().getAssets().open("food_truck.json");
