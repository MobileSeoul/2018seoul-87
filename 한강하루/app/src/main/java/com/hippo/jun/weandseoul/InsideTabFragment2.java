...
public class InsideTabFragment2 extends Fragment {

    public InsideTabFragment2(){
        // 빈 생성자 필수
    }

    String domain = "http://tkstka0023.cafe24.com/exercise/";
    int openNum;

    @Override
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        View view = inflater.inflate(R.layout.inside_tab_fragment2, container, false);
        ...
        if(!parkNameEng.equals("nanji")) {
            ...
            Intent intent = new Intent(getActivity(), PlaceInfoActivity2.class);
